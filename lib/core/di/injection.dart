...
import 'package:vibra/features/auth/repositories/auth_repository.dart'; // Corrected import path
...
void setupLocator() {
  // Repositories
  getIt.registerLazySingleton<AuthRepository>(() => AuthRepository()); // Corrected
